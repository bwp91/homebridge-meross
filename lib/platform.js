    ...
    try {
      ...
      try {
        ...
        try {
          ...
          this.accountDetails.domain = splitData[4]; // eslint-disable-line prefer-destructuring
  ...
  async initialiseDevice(device) {
    try {
      ...
      if (platformConsts.models.switchSingle.includes(device.model)) {
        ...
        if ((this.config.enablePowerStrip == true) && (hasProperty(platformConsts.models.powerStrip, device.model))) {
