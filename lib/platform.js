...
import deviceBaby from './device/baby.js';
import deviceCoolerSingle from './device/cooler-single.js';
import deviceDiffuser from './device/diffuser.js';
import deviceGarageMain from './device/garage-main.js';
import deviceGarageSingle from './device/garage-single.js';
import deviceGarageSub from './device/garage-sub.js';
import deviceHeaterSingle from './device/heater-single.js';
import deviceHubMain from './device/hub-main.js';
import deviceHubSensor from './device/hub-sensor.js';
import deviceHubValve from './device/hub-valve.js';
import deviceHumidifier from './device/humidifier.js';
import deviceLightCCT from './device/light-cct.js';
import deviceLightDimmer from './device/light-dimmer.js';
import deviceLightRGB from './device/light-rgb.js';
import deviceOutletMulti from './device/outlet-multi.js';
...
import deviceRoller from './device/roller.js';
import deviceSwitchMulti from './device/switch-multi.js';
import deviceSwitchSingle from './device/switch-single.js';
import deviceThermostat from './device/thermostat.js';
...
export default class {
  ...
  async pluginSetup() {
    ...
    try {
      ...
      try {
        ...
        const eText = platformFuncs.parseError(err, [platformLang.missingCreds]);
      ...
      const eText = platformFuncs.parseError(err, [platformLang.disabled, platformLang.noCredentials]);
    ...
    try {
      ...
      if (platformConsts.models.switchSingle.includes(device.model)) {
        ...
        switch (deviceConf.showAs) {
          case 'cooler':
            accessory.control = new deviceCoolerSingle(this, accessory);
            break;
          case 'heater':
            accessory.control = new deviceHeaterSingle(this, accessory);
            break;
          case 'outlet':
            accessory.control = new deviceOutletSingle(this, accessory);
            break;
          case 'purifier':
            accessory.control = new devicePurifierSingle(this, accessory);
            break;
          default:
            accessory.control = new deviceSwitchSingle(this, accessory);
        }
        /** ************ */
      } else if (platformFuncs.hasProperty(platformConsts.models.switchMulti, device.model)) {
        /** *************
         SWITCHES (MULTI)
         ************** */
        ...
        device.channels.forEach((channel, index) => {
          ...
          switch (deviceConf.showAs) {
            case 'outlet':
              subAcc.control = new deviceOutletMulti(this, subAcc);
              break;
            default:
              subAcc.control = new deviceSwitchMulti(this, subAcc);
              break;
          }
        ...
        accessory = this.devicesInHB.get(hbUUID) || this.addAccessory(device);
        accessory.context = { ...accessory.context, ...context };
        accessory.control = new deviceLightRGB(this, accessory);
        /** ******* */
        ...
        accessory = this.devicesInHB.get(hbUUID) || this.addAccessory(device);
        accessory.context = { ...accessory.context, ...context };
        accessory.control = new deviceLightCCT(this, accessory);
        /** ******* */
        ...
        if (device.model === 'MSG200') {
          ...
          accessory.control = new deviceGarageMain(this, accessory);
          ...
          device.channels.forEach((channel, index) => {
            ...
            // Create the device type instance for this accessory
            subAcc.control = new deviceGarageSub(this, subAcc, accessory);
          ...
          accessory = this.devicesInHB.get(hbUUID) || this.addAccessory(device);
          accessory.context = { ...accessory.context, ...context };
          accessory.control = new deviceGarageSingle(this, accessory);
        }
        /** ******* */
        ...
        accessory = this.devicesInHB.get(hbUUID) || this.addAccessory(device);
        accessory.context = { ...accessory.context, ...context };
        accessory.control = new deviceRoller(this, accessory);
        /** ******** */
        ...
        accessory.context = { ...accessory.context, ...context };
        accessory.control = new deviceBaby(this, accessory, accessoryLight);
        /** ******* */
        ...
        accessory = this.addAccessory(device, true);
        accessory.context = { ...accessory.context, ...context, ...{ hidden: true } };
        accessory.control = new deviceHubMain(this, accessory);
        ...
        subdevices.forEach((subdevice) => {
          try {
            ...
            switch (subdeviceObj.model) {
              case 'MS100':
                subAcc.control = new deviceHubSensor(this, subAcc);
                break;
              case 'MTS100V3':
              case 'MTS150':
                subAcc.control = new deviceHubValve(this, subAcc, accessory);
                break;
              default:
                return;
            }
  ...
  async sendUpdate(accessory, toSend) {
    ...
    try {
      ...
      const messageId = platformFuncs.generateRandomString(32);
      const sign = crypto
        .createHash('md5')
