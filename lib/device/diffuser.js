...
export default class {
  ...
  applyUpdate(data) {
    ...
    if (data.light && data.light[0]) {
      if (platformFuncs.hasProperty(data.light[0], 'onoff')) {
      ...
      if (platformFuncs.hasProperty(data.light[0], 'luminance')) {
      ...
      if (data.light[0].mode === 1) {
        ...
        if (platformFuncs.hasProperty(data.light[0], 'rgb')) {
          const [r, g, b] = colourUtils.mr2hkRGB(data.light[0].rgb);
