...
module.exports = class deviceBaby {
  constructor (platform, accessory) {
    ...
    this.speakerService
      .getCharacteristic(this.hapChar.Volume)
  ...
  async internalVolumeUpdate (value) {
    this.log.error('SET Volume: ', value)
  ...
  applyUpdate (data) {
    ...
    if (this.funcs.hasProperty(data, 'volume')) {
      ...
      if (data.volume !== this.cacheVolumeMR) {
        ...
        this.speakerService.updateCharacteristic(this.hapChar.VolumeSelector, this.cacheVolume)
        if (this.enableLogging) {
