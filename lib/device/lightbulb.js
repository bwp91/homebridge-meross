      ...
      if (data.all && data.all.digest) {
        if (this.accessory.context.model === 'MSS1101') {
          ...
          if (data.all.digest.light) {
            if (this.funcs.hasProperty(data.all.digest.light, 'luminance')) {
            ...
            if (this.funcs.hasProperty(data.all.digest.light, 'rgb') && data.all.digest.light !== -1) {
            ...
            if (this.funcs.hasProperty(data.all.digest.light, 'temperature') && data.all.digest.light.temperature !== -1) {
