...
module.exports = class deviceGarage {
  constructor (platform, accessory) {
    ...
    this.service
      ...
      .onSet(async value => await this.internalCloudTargetUpdate(value))
    ...
    try {
      ...
      const res =
        this.accessory.context.connection === 'cloud'
          ? await this.accessory.mqtt.getGarageDoorState()
  ...
  externalUpdate (namespace, params) {
    try {
      ...
      this.log.warn('[%s] real-time garage cloud updates not supported.', this.name)
