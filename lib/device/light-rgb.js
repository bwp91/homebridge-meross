...
module.exports = class deviceLightRGB {
  constructor (platform, accessory) {
    ...
    this.cacheMode = 'rgb'
    this.capacityOverride = this.accessory.context.options.capacityOverride
      ...
      return await this.queue.add(async () => {
        ...
        const payload = {
          light: {
            ...
            capacity: this.cacheMode === 'rgb' && !this.capacityOverride ? 1 : 5,
      ...
      return await this.queue.add(async () => {
        ...
        const payload = {
          light: {
            ...
            capacity: this.cacheMode === 'cct' && !this.capacityOverride ? 2 : 6,
            luminance: this.cacheBright,
            channel: 0
          }
        }
