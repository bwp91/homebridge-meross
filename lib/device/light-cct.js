...
module.exports = class deviceLightCCT {
  constructor (platform, accessory) {
    ...
    if (this.hasNightLight) {
      ...
      this.service
        ...
        .onSet(async value => await this.internalNightUpdate(6, value))
      this.service
        .getCharacteristic(this.cusChar.LightNightWarm)
        .onSet(async value => await this.internalNightUpdate(5, value))
  ...
  applyUpdate (data) {
    ...
    if (data.light) {
      ...
      if (this.funcs.hasProperty(data.light, 'temperature')) {
