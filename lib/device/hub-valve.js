...
module.exports = class deviceHubValve {
  constructor (platform, accessory, priAcc) {
    ...
    */
    ...
    this.service
      ...
      .onSet(async value => await this.internalModeUpdate(value, 1))
    ...
    this.service
      ...
      .onSet(async value => await this.internalModeUpdate(value, 2))
    ...
    this.service
      ...
      .onSet(async value => await this.internalModeUpdate(value, 3))
    ...
    this.service
      ...
      .onSet(async value => await this.internalModeUpdate(value, 4))
  ...
  async internalModeUpdate (value, newMode) {
    try {
      ...
      return await this.queue.add(async () => {
        // Don't continue if the state is the same as before
        if (!value || newMode === this.cacheMode) {
          return
        }
