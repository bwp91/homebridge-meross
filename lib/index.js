  ...
  async initialiseDevice (device) {
    try {
      ...
      if (device.connection === 'local') {
        ...
        if (!device.deviceUrl || !device.model) {
          throw new Error(this.lang.devNoAttributes)
        }
        ...
        const channelCount = this.consts.models.channelCount[device.deviceType]
      ...
      const eText = this.funcs.parseError(err, [this.lang.accNotFound, this.lang.devNoAttributes])
