    ...
    try {
      ...
      if (this.consts.models.switchSingle.includes(device.model)) {
        ...
        **********/
        ...
        /******/
      } else if (this.consts.models.baby.includes(device.model)) {
        /************
        BABY MONITORS
        ************/
        ...
        const accessoryLight =
          this.devicesInHB.get(deviceLightHBUUID) || this.addAccessory(deviceLight)
        ...
        // Setup the main accessory for the baby monitor
        accessory.context = { ...accessory.context, ...context }
        accessory.control = new (require('./device/baby'))(this, accessory, accessoryLight)
        /**********/
      } else if (this.consts.models.thermostat.includes(device.model)) {
        /**********
        THERMOSTATS
        **********/
        accessory = this.devicesInHB.get(hbUUID) || this.addAccessory(device)
